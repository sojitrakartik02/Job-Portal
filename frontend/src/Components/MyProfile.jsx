                ...
                user && user.role === "Job Seeker" && (
                    <div>
                        ...
                        <div className='' style={{ display: "flex", flexDirection: "column", gap: "15px" }}>
                            <input type="email" disabled value={user && user.niches.firstNiche} onChange={e => e.target.value} />
                        </div>
                        <div className='' style={{ display: "flex", flexDirection: "column", gap: "15px" }}>
                            <input type="email" disabled value={user && user.niches.secondNiche} onChange={e => e.target.value} />
                        </div>
                        <div className='' style={{ display: "flex", flexDirection: "column", gap: "15px" }}>
                            <input type="email" disabled value={user && user.niches.thirdNiche} onChange={e => e.target.value} />
                        </div>
                    </div>
                )
            }
