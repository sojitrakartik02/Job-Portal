...
import { clearAllJobErrors, fetchJob } from '../store/slices/jobSlice'
...
const Jobs = () => {
    ...
    const handleSearch = () => {
        console.log('City:', city, 'Niche:', niche, 'SearchKeyword:', searchKeyword);
                                    ...
                                    jobs && jobs.map(element => {
                                        return (
                                            <div className="card" key={element._id}>
                                                ...
                                                <p className='salarys'><span>Salary:</span>{element.salary}</p>
                                                <p className='posted'><span>Posted On:</span>{element.jobPostedOn.substring(0, 10)}</p>
                                                <div className='btn-wrapper'>
                                                    <Link to={`/post/application/${element._id}`} className='btn' >Apply Now</Link>
                                                </div>
                                            </div>
                                        )
                                    })
